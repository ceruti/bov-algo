...
@ActiveProfiles({"test", "strategy-variable_amount_favor_long_geometric"})
public class StrategyVariableAmountsFavorLongOddsGeometricIT extends StrategyAnalysisIntegrationTests {
